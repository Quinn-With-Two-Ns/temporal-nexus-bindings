...
public @interface SignalOperation {
  ...
  /**
   * The ID of the workflow to signal.
   *
  ...
  /**
   * Expressions that produce the Temporal signal method arguments, in parameter order.
   *
   ...
   * method.
   *
   * @return the signal argument expressions
   */
